#ifndef QC_NAVBUTTON_H
#define QC_NAVBUTTON_H
...
class QDESIGNER_WIDGET_EXPORT QC_NavButton : public QPushButton
#else
class QC_NavButton : public QPushButton
#endif
...
public:
    ...
    explicit QC_NavButton(QWidget *parent = 0);
