#ifndef QC_LISTVIEW_H
#define QC_LISTVIEW_H
...
class NavDelegate : public QStyledItemDelegate
{
    Q_OBJECT
public:
    NavDelegate(QObject *parent, QC_ListView *nav);
    ~NavDelegate();
...
class QDESIGNER_WIDGET_EXPORT QC_ListView : public QListView
#else
class QC_ListView : public QListView
#endif
